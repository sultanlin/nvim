    ...
    config = function()
        ...
        local function get_jdtls_paths()
            ...
            if os.getenv("LSP_JAVA_TEST") ~= nil then
                java_test_path = os.getenv("LSP_JAVA_TEST")
                    .. "/share/vscode/extensions/vscjava.vscode-java-test/server"
            elseif not os.getenv(LSP_JAVA_PATH) then
                java_test_path = require("mason-registry").get_package("jdtls"):get_install_path()
                    .. "/extension/server"
            end
            ...
            if os.getenv("LSP_JAVA_DEBUG") ~= nil then
                java_debug_path = os.getenv("LSP_JAVA_DEBUG")
